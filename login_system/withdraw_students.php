...
$total = is_object($result) ? mysqli_num_rows($result) : 0;
}
?>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="h4 mb-0 text-primary fw-bold">
                        <i class="fas fa-user-minus me-2"></i>Withdraw Students
                    </h2>
                    <small class="text-muted">List of students with withdrawn enrollment status</small>
                </div>
            </div>
            <div>
                <span class="badge bg-danger fs-6 px-3 py-2 rounded-pill">
                    <i class="fas fa-users me-1"></i> Total Withdrawn: <?php echo $total; ?>
                </span>
            </div>
        </div>
    </div>
